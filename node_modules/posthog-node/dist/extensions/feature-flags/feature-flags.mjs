import { InconclusiveMatchError, getFeatureFlagHash, getFeatureFlagVariant, getFeatureFlagVariantLookupTable, matchFeatureFlagProperty, parseFeatureFlagSemver, raceWithTimeout, relativeDateParseForFeatureFlagMatching, resolveFeatureFlagPayload, safeSetTimeout } from "@posthog/core";
...
class FeatureFlagsPoller {
    ...
    async isConditionMatch(flag, bucketingValue, condition, properties, evaluationContext) {
        ...
        if (void 0 != rolloutPercentage && await getFeatureFlagHash(flag.key, bucketingValue) > rolloutPercentage / 100.0) return 'out_of_rollout_bound';
        return 'match';
    }
