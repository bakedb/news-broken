import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-UAOEWFX4.js";
import {
  insertCluster
} from "./chunk-ZSB4WBHB.js";
import {
  insertNode
} from "./chunk-YK3HMJSV.js";
import {
  labelHelper
} from "./chunk-VZUOGAH4.js";
import {
  interpolateToCurve
...
// node_modules/@tinacms/app/node_modules/mermaid/dist/chunks/mermaid.core/chunk-TLUHSLCS.mjs
var internalHelpers = {
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-GXQ25YYZ-ZGKEW33F.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-42K2YHIH-564MTUDX.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-PJ7XHIU6.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-HX3DHH2U.js.map
